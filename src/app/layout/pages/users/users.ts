...
export class Users {
  ...
  tableActions: TableAction[] = [
    {
      ...
      icon: 'edit',
      callback: (row) => this._router.navigate(['/users/edit', row.id]),
    },

    // {
    //   label: 'USERS.VIEW_USER',
    //   icon: 'eye',
    //   callback: (row) => this._router.navigate(['/users/profile', row.id]),
  ...
  topButtons: HeaderButton[] = [
    {
      label: 'USERS.ADD_USER',
      icon: 'plus',
      colorClass: 'btn-primary',
      action: () => this._router.navigate(['/users/add']),
    },
  ];
